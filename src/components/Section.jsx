...
export default function Section() {
    return (
        ...
        <div className="container">
          ...
          <Card title="Product 2" description='Lorem ipsum dolor sit amet, consectetur adipiscing elit.' image={image1} />
          <Card title="Product 3" description='Lorem ipsum dolor sit amet, consectetur adipiscing elit.' image={image1} />
